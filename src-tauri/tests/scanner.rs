...
#[test]
fn scans_all_levels_and_sorts_directories_before_natural_file_names() {
    let root = tempdir().unwrap();
    ...
    assert_eq!(names[2], (ItemKind::File, "深层项目.txt".into()));
    assert_eq!(names[3], (ItemKind::File, "项目2.txt".into()));
    assert_eq!(names[4], (ItemKind::File, "项目10.txt".into()));
}
